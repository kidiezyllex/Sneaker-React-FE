...
export default function SearchReturnModal({
  isOpen,
  onClose,
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useSearchReturn({ query: searchQuery });
                ...
                {isLoading ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-maintext">
                      Không tìm thấy yêu cầu trả hàng nào phù hợp
                    </p>
                  ...
                  <div className="space-y-4">
                    <p className="text-sm text-maintext">
                      Tìm thấy <strong>{searchResults?.data.length}</strong> kết
                      quả cho "{searchQuery}"
                    </p>

    ...
    <>
      ...
      <footer className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 text-white">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-20 -left-20 w-60 h-60 bg-gradient-to-br from-primary/20 to-blue-400/20 rounded-full blur-3xl" />
          <div className="absolute top-1/2 -right-32 w-80 h-80 bg-gradient-to-br from-purple-400/15 to-pink-400/15 rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 pt-16 pb-8">
          <div className="container mx-auto px-6">
              ...
              <div className="flex justify-center items-center gap-4 mb-8">
                ...
                {socialLinks.map((link, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className={`p-3 bg-white/10 backdrop-blur-sm rounded-md border border-white/20 transition-all duration-300 ${link.hoverColor} hover:-translate-y-1 hover:border-white/40 group`}
                  >
                    <img
                      src={link.src}
                      alt={link.name}
            ...
            <div className="flex justify-center items-center gap-3 sm:hidden">
              {socialLinks.map((link, index) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-2 bg-white/10 backdrop-blur-sm rounded-md border border-white/20 transition-all duration-300 hover:bg-white/20 hover:-translate-y-1"
                >
                  <img
                    src={link.src}
                    alt={link.name}
            ...
            <div className="sm:hidden mt-8 pt-4 border-t border-white/20 text-center">

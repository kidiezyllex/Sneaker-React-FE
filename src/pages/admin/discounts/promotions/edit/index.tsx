...
export default function EditPromotionPage() {
    ...
    useEffect(() => {
        if (promotionData?.data) {
            ...
            // Extract product IDs
            const pIds = Array.isArray(promotion.products)
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const originalStartDate = new Date(promotionData!.data.startDate);
        ...
        try {
            await updatePromotion.mutateAsync(
                { promotionId, payload: submitData },
                {
                    ...
                    onError: (error) => {
                        toast.error("Cập nhật chiến dịch khuyến mãi thất bại: " + error.message);
                    }
                }
            );
        } catch (error) {
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) => handleSelectAllProducts(checked as boolean)}
                                    />
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="text-sm text-blue-800 space-y-1">
                                                <p>
                                                    <strong>Mã:</strong> {promotionData.data.code}
                                                </p>
                                                <p>
                                                    <strong>Tên:</strong> {formData.name || "Chưa nhập"}
                                                </p>
                                                <p>
                                                    <strong>Giảm giá:</strong> {formData.discountPercent}%
                                                </p>
                                                <p>

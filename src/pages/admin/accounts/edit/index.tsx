...
export default function AdminAccountEditPage() {
    ...
    const { data: accountData, isLoading, error } = useAccount(id as string);
    const updateAccount = useUpdateAccount(id as string);
    const updateAccountStatus = useUpdateAccountStatus(id as string);
    ...
    useEffect(() => {
        if (accountData?.data) {
            ...
            const formGender = account.gender;

                ...
                <div className="border rounded-[6px]">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="px-4 py-3 text-left text-sm font-medium text-maintext uppercase tracking-wider">
                          Sản phẩm
                        </th>
                        <th className="px-4 py-3 text-right text-sm font-medium text-maintext uppercase tracking-wider">
                          Đơn giá
                        </th>
                        <th className="px-4 py-3 text-right text-sm font-medium text-maintext uppercase tracking-wider">
                          Số lượng

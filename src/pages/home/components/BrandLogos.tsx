...
export const BrandLogos = () => {
  return (
    <section className="py-12 pb-0 bg-gradient-to-br bg-white relative overflow-hidden">
      <h2 className="text-2xl font-semibold text-center mb-8 relative">
      ...
      <div className="container mx-auto relative z-10 mt-10">
        <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
          ...
          <ul
            className="flex items-center justify-center md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-logo-cloud"
            aria-hidden="true"
          >
            {logos.map((logo) => (
              <li

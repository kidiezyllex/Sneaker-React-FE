...
const TestimonialCard = ({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -10 }}
      className="group bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700"
    >
